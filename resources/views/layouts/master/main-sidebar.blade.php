...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href=#><img src="{{URL::asset('assets/img/brand/logo_repo.png ')}}"
    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('get-categories') }}">
                        ...
                        <span class="side-menu__label">Categories</span><span
                            class="badge badge-danger side-badge">New</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . $page='add-category') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                        ...
                        <span class="side-menu__label">products</span><span
                            class="badge badge-danger side-badge">New</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . $page='categories') }}">
                        ...
                        <span class="side-menu__label">Invoices</span><span
                            class="badge badge-danger side-badge">New</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . $page='add-category') }}">
